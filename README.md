...
Total: **480** lines of code across **23** files in the top 5 languages.
...
- **Upstream**: <https://github.com/ljh-sh/silk>
- **Homepage**: <https://silk.ljh.sh>
- **License**: NOASSERTION
...
- **Stars**: 2 · **Forks**: 0 · **Open issues**: 0 · **Contributors**: 2

## Totals (cumulative)

- **Releases**: 2 · **Merged PRs**: 24 · **Open PRs**: 8 · **Closed issues**: 0 · **Open issues**: 0 · **Commits**: 34
...
Reported by **5** distros on [repology.org](https://repology.org/project/silk). **3** are ✅ on the latest upstream release, **2** are ⚠️ on an older version.
...
_Snapshot: `data/card/260913.yml` · 2026-09-13T05:47:49Z._
